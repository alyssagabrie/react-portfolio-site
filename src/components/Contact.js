...
const Contact = () => {
  ...
  <div className='container mx-auto'>
    ...
    className='flex-1 border rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start'>
      ...
      <textarea
        className='bg-transparent border-b py-3 outline-none w-full placeholder:text-white focus:border-accent transition-all resize-none mb-12' placeholder='Your message'
      >
      </textarea>
